...
import { TreePine, MapPin, SproutIcon, Building, FactoryIcon, LucideConstruction } from "lucide-react"
...
export default function KeyFeatures() {
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-10 p-10">
        <div className="flex  rounded-lg p-4 bg-white">
        ...
        <div className="flex rounded-lg p-4 bg-white">
            <LucideConstruction width={48} height={48}/>
            <div className="ml-2">
